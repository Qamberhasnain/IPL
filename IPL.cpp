...
void credits()
	{
	    int z;
		int o;
	   cout<<"Creater of this software is Qamber Hasnain."<<endl;
	   cout<<"Some References/websites for data only:-\n1.https://www.ipl.com/wikipedia \n2.http://www.espncricinfo.com"<<endl;
	   cout<<"\n\nDo you want to see some more info about creater of this software? (press 1 for YES and 0 for NO)"<<endl;
	   cout<<"\nYOUR OPTION: ";
	   cin>>o;
	   if(o==1)
	   {
	   	 cout<<"\nMore Info About Creater:-";
